...
import { outwizeServicesImages } from "@/data/outwizeServicesImages";
import { DOWNLOAD_LINKS, PUBLIC_LINKS } from "@/configs/public-links";
      ...
      >
        <div className="container text-center">
          ...
          <p className="lead mx-auto" style={{ maxWidth: 700 }}>
            Outwize has a proven track record of supporting computational modeling, virtual docking and bioavailability optimization projects using an array of commercial and proprietary computational tools.
          </p>
        </div>
      </section>
      ...
      <section className="container py-5">
        <div className="row align-items-center mb-5">
          <div className="col-lg-6 mb-4 mb-lg-0">
            <img
              src={outwizeServicesImages.structureBased}
          ...
          <div className="col-lg-6">
            ...
            <p className="lead">
              ...
              <a href={DOWNLOAD_LINKS.macrocycles1m} className="text-blue-600 underline">
                1 million
              </a>{" "}
              and 1 billion (
              <a href={PUBLIC_LINKS.contact} className="text-blue-600 underline">
            ...
            <a href={PUBLIC_LINKS.contact} target="_blank" rel="noopener noreferrer" className="btn btn-outline-primary mt-2">
        ...
        <div className="row align-items-center mb-5 flex-row-reverse">
          <div className="col-lg-6 mb-4 mb-lg-0">
            <img
              src={outwizeServicesImages.queryBased}
          ...
          <div className="col-lg-6">
            ...
            <p className="lead">
              ...
              <a href={DOWNLOAD_LINKS.macrocycles10k} className="text-blue-600 underline">
        ...
        <div className="row align-items-center mb-5">
          <div className="col-lg-6 mb-4 mb-lg-0">
            <img
              src={outwizeServicesImages.propertyBased}
          ...
          <div className="col-lg-6">
            ...
            <p className="lead">
              Outwize has years of experience in designing cell-permeable and CNS-like compounds, as demonstrated in our{" "}
        ...
        <div className="row align-items-center mb-5 flex-row-reverse">
          <div className="col-lg-6 mb-4 mb-lg-0">
            <img
              src={outwizeServicesImages.synthesisOnDemand}
        ...
        <div className="row">
          <div className="col text-center">
            ...
            <a href={PUBLIC_LINKS.contact} target="_blank" rel="noopener noreferrer" className="btn btn-success ms-2" role="button">
              Contact Outwize
            </a>
          </div>
        </div>
