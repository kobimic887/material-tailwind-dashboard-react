...
export function SignIn() {
  ...
  return (
    <section className="about-us-page m-8 flex gap-4">
      ...
      <div className="w-full lg:w-3/5 mt-24">
        ...
        <div className="text-center">
          <h1 className="display-3 fw-bold mb-4">Sign In</h1>
          <p className="lead text-blue-gray-700 mb-6">Enter your username and password to Sign In.</p>
        </div>
